  ...
  return (
    <div className="flex flex-col lg:w-1/2 md:w-1/2 w-full gap-6" style={{padding:"24px"}}>
      <div className='flex justify-between items-center'>
        <p className='font-semibold text-white text-lg' style={{textShadow: "4px 4px 2px rgba(0,0,0,0.6)"}}>Address detail</p>
      ...
      <div className='flex flex-col w-full rounded-lg bg-white gap-2' style={{padding:"34px",boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
        <div className='text-sm font-normal p-3' style={{borderBottom:"1px solid #DCDCDC"}}>Delivery to Iskandar Street</div>
        <div className='text-sm font-normal p-3' style={{borderBottom:"1px solid #DCDCDC"}} >Km 5 refinery road oppsite re
        public road, effurun, Jakarta</div>
        <div className='text-sm font-normal p-3' style={{borderBottom:"1px solid #DCDCDC"}} >+62 81348287878</div>
      </div>
      <div>
